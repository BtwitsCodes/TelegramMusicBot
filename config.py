...
BOT_NAME = getenv("BOT_NAME", "Luffy Music Bot")
...
_ALIVE_IMG = getenv("ALIVE_IMG", "https://telegra.ph/file/c83b000f004f01897fe18.png")
API_ID = int(getenv("API_ID"))
API_HASH = getenv("API_HASH")
BOT_USERNAME = getenv("BOT_USERNAME", "Luffy_Music_Bot")
ASSISTANT_NAME = getenv("ASSISTANT_NAME", "LuffySinger")
GROUP_SUPPORT = getenv("GROUP_SUPPORT", "LuffySupportGroup")
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "Onepiece_Network")
# isi dengan username kamu tanpa simbol @
OWNER_NAME = getenv("OWNER_NAME", "Luffy")
# fill with your nickname
ALIVE_NAME = getenv("ALIVE_NAME", "Luffy")
